...
export const themes: Record<string, BadgeTheme> = {
  ...
  software: {
    ...
    tooltip: "bg-violet-50 border-violet-300 dark:bg-violet-900/30 dark:border-violet-700",
  ...
  model: {
    ...
    tooltip: "bg-sky-50 border-sky-300 dark:bg-sky-900/30 dark:border-sky-700",
    glow: "shadow-[0_0_8px_rgba(14,165,233,0.3)]",
  },
  data: {
    desc: "Data license governing dataset usage and redistribution",
    badge: "bg-orange-100 text-orange-800 dark:bg-orange-900/40 dark:text-orange-300",
    tooltip: "bg-orange-50 border-orange-300 dark:bg-orange-900/30 dark:border-orange-700",
  ...
  agent: {
    ...
    tooltip: "bg-purple-50 border-purple-300 dark:bg-purple-900/30 dark:border-purple-700",
  ...
  osi: {
    ...
    tooltip: "bg-green-50 border-green-300 dark:bg-green-900/30 dark:border-green-700",
  ...
  fsf: {
    ...
    tooltip: "bg-red-50 border-red-300 dark:bg-red-900/30 dark:border-red-700",
    glow: "shadow-[0_0_8px_rgba(177,17,7,0.3)]",
  },
  verified: {
    desc: "Verified by tl;drLegal — license summary reviewed for accuracy",
    badge: "",
    tooltip: "bg-gradient-to-r from-[#eaf5f0] to-[#e6f4fc] border-[#8dd4b5] dark:from-[#289e6d]/20 dark:to-[#0096e2]/20 dark:border-[#289e6d]/50",
  ...
  proprietary: {
    ...
    tooltip: "bg-amber-50 border-amber-300 dark:bg-amber-900/30 dark:border-amber-700",
  ...
  permissive: {
    ...
    tooltip: "bg-teal-50 border-teal-300 dark:bg-teal-900/30 dark:border-teal-700",
  ...
  "public-domain": {
    ...
    tooltip: "bg-cyan-50 border-cyan-300 dark:bg-cyan-900/30 dark:border-cyan-700",
  ...
  copyleft: {
    ...
    tooltip: "bg-rose-50 border-rose-300 dark:bg-rose-900/30 dark:border-rose-700",
  ...
  "weak-copyleft": {
    ...
    tooltip: "bg-pink-50 border-pink-300 dark:bg-pink-900/30 dark:border-pink-700",
  ...
  "creative-commons": {
    ...
    tooltip: "bg-neutral-50 border-neutral-300 dark:bg-neutral-800/30 dark:border-neutral-600",
  ...
  modelgo: {
    ...
    tooltip: "bg-gradient-to-r from-violet-50 to-blue-50 border-violet-300 dark:from-violet-900/30 dark:to-blue-900/30 dark:border-violet-700",
  ...
  custom: {
    ...
    tooltip: "bg-fuchsia-50 border-fuchsia-300 dark:bg-fuchsia-900/30 dark:border-fuchsia-700",
    glow: "shadow-[0_0_8px_rgba(217,70,239,0.3)]",
  },
  huggingface: {
    desc: "License found on a HuggingFace Hub model",
    badge: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/40 dark:text-yellow-300",
    tooltip: "bg-yellow-50 border-yellow-300 dark:bg-yellow-900/30 dark:border-yellow-700",
  ...
  "agent-framework": {
    ...
    tooltip: "bg-indigo-50 border-indigo-300 dark:bg-indigo-900/30 dark:border-indigo-700",
    glow: "shadow-[0_0_8px_rgba(99,102,241,0.3)]",
  },
  "agent-skill": {
    desc: "License from an AI agent skill/plugin project",
    badge: "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-300",
    tooltip: "bg-emerald-50 border-emerald-300 dark:bg-emerald-900/30 dark:border-emerald-700",
...
const variantFallbacks: Record<BadgeVariant, string> = {
  type: "bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300",
...
export function Badge({ children, variant = "tag", className }: BadgeProps) {
  ...
  return (
    <span className="group/badge relative">
      ...
      <span
        className={cn(
          "pointer-events-none absolute top-full left-1/2 z-[60] mt-1.5 -translate-x-1/2 whitespace-normal rounded-lg border px-2.5 py-1.5 text-[11px] font-medium leading-snug text-zinc-700 opacity-0 transition-opacity duration-150 group-hover/badge:opacity-100 dark:text-zinc-300",
          tipStyle,
          tipGlow,
        )}

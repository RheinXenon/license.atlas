...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "about.src.osadl": "Open Source License Checklists with obligation, prohibition, copyleft, source-disclosure, patent-hint, and compatibility data",
    "about.osadlTitle": "OSADL Checklist Data",
    "about.osadlIntro": "LicenseAtlas uses {records} OSADL Open Source License Checklist records, currently matched to {matched} LicenseAtlas licenses. OSADL raw checklist material is distributed under the {license}; LicenseAtlas attributes OSADL as the source when displaying this data.",
  ...
  zh: {
    ...
    "about.src.osadl": "开源许可证检查清单数据，包含义务、禁止项、Copyleft、源码披露、专利提示与兼容性信息",
    "about.osadlTitle": "OSADL 检查清单数据",
    "about.osadlIntro": "LicenseAtlas 使用 {records} 条 OSADL Open Source License Checklist 记录，目前匹配到 {matched} 个 LicenseAtlas 许可证。OSADL 原始检查清单材料采用 {license} 发布；LicenseAtlas 展示这些数据时会标注 OSADL 来源。",

...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "tagdesc.bo-model": "Model — the ideal permissive license (Blue Oak Council rating)",
    "tagdesc.bo-gold": "Gold — addresses patents explicitly, robust language (Blue Oak Council rating)",
    "tagdesc.bo-silver": "Silver — robust language, may lack explicit patent terms (Blue Oak Council rating)",
    "tagdesc.bo-bronze": "Bronze — lacks some nonessential elements (Blue Oak Council rating)",
    "tagdesc.bo-lead": "Lead — lacks essential elements or has burdensome requirements (Blue Oak Council rating)",
    ...
    "detail.blueOak.model": "The model license demonstrates all the characteristics the council looks for in a permissive open software license.",
    "detail.blueOak.gold": "These licenses address patents explicitly, use robust language, and require only simple notice of license terms and copyright notices.",
    "detail.blueOak.silver": "These licenses use robust language but either fail to address patents explicitly or require more than simple notice of license terms and copyright notices.",
    "detail.blueOak.bronze": "These licenses lack important but nonessential elements of permissive open software licenses or impose additional requirements or restrictions.",
    "detail.blueOak.lead": "These licenses lack one or more essential elements of permissive open software licenses or impose unusually burdensome requirements.",
    "bo.model": "Model",
    "bo.gold": "Gold",
    "bo.silver": "Silver",
    "bo.bronze": "Bronze",
  ...
  zh: {
    ...
    "tagdesc.bo-model": "展示了委员会所期望的宽松开源许可证的全部特征（Blue Oak Council 评级）",
    "tagdesc.bo-gold": "明确处理专利问题，使用严谨的语言，仅需简单的许可条款和版权声明（Blue Oak Council 评级）",
    "tagdesc.bo-silver": "使用严谨的语言，但未明确处理专利问题或有额外要求（Blue Oak Council 评级）",
    "tagdesc.bo-bronze": "缺少宽松开源许可证的重要但非必要元素，或有额外限制（Blue Oak Council 评级）",
    "tagdesc.bo-lead": "缺少宽松开源许可证的必要元素，或施加异常繁重的要求（Blue Oak Council 评级）",
    ...
    "detail.blueOak.model": "模板许可证展示了委员会所期望的宽松开源许可证的全部特征。",
    "detail.blueOak.gold": "这些许可证明确处理专利问题，使用严谨的语言，仅需简单的许可条款和版权声明。",
    "detail.blueOak.silver": "这些许可证使用严谨的语言，但未能明确处理专利问题，或要求超出简单的许可条款和版权声明。",
    "detail.blueOak.bronze": "这些许可证缺少宽松开源许可证的重要但非必要元素，或施加额外要求和限制，例如 BSD 风格的禁止背书和推广条款。",
    "detail.blueOak.lead": "这些许可证缺少宽松开源许可证的一个或多个必要元素，或施加异常繁重的要求。许多许可证使用了不清晰、戏谑或不完整的语言。",
    "bo.model": "模板",
    "bo.gold": "金级",
    "bo.silver": "银级",
    "bo.bronze": "铜级",

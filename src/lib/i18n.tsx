...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "detail.blueOak.model": "Model — Demonstrates all characteristics of an ideal permissive license",
    "detail.blueOak.gold": "Gold — Addresses patents explicitly, robust language, simple requirements",
    "detail.blueOak.silver": "Silver — Robust language, may lack explicit patent terms or require more than simple notice",
    "detail.blueOak.bronze": "Bronze — Lacks some nonessential elements or imposes additional restrictions",
    "detail.blueOak.lead": "Lead — Lacks essential elements or imposes unusually burdensome requirements",
    "bo.model": "Model",
    "bo.gold": "Gold",
    "bo.silver": "Silver",
    "bo.bronze": "Bronze",
  ...
  zh: {
    ...
    "detail.blueOak.model": "典范 — 展示理想宽松许可证的所有特征",
    "detail.blueOak.gold": "金级 — 明确处理专利问题，语言严谨，要求简单",
    "detail.blueOak.silver": "银级 — 语言严谨，但可能缺少明确的专利条款或有额外要求",
    "detail.blueOak.bronze": "铜级 — 缺少部分非必要元素或有额外限制",
    "detail.blueOak.lead": "铅级 — 缺少必要元素或有异常繁重要求",
    "bo.model": "典范",
    "bo.gold": "金级",
    "bo.silver": "银级",
    "bo.bronze": "铜级",
